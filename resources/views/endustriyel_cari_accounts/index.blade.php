...
<div class="container mt-5">
    <h1 class="text-center mb-4 text-secondary">Endüstriyel Cari Hesap Listesi</h1>
    ...
    <div class="row mb-4 text-center g-2">
        <div class="col-md-4 col-12">
            <a href="{{ route('endustriyel.cari.create') }}" class="btn btn-dark w-100">
                <i class="bi bi-plus-circle"></i> Yeni Cari Hesap Ekle
            </a>
        </div>
        <div class="col-md-4 col-12">
            <a href="{{ route('endustriyel.firms.create') }}" class="btn btn-dark w-100">
    ...
    <div class="card shadow-sm border border-secondary">
        <div class="card-body">
            <div class="table-responsive"> <!-- Mobilde yatay kaydırma için -->
                <table class="table table-bordered text-center align-middle bg-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('endustriyel.cari.show', $row['id']) }}" class="btn btn-dark btn-sm">
