...
<div class="container mt-5">
    <h2 class="mb-4 text-center text-secondary">İşletmecilik Cari Hesap Detayları</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                <a href="{{ route('isletmecilik.cari.edit', $account->id) }}" class="btn btn-dark btn-sm">Güncelle</a>
                                <form action="{{ route('isletmecilik.cari.destroy', $account->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
